        ...
        <div className='bg-white p-[24px] h-[350px] w-full rounded-[7px] border border-[#DFE6E9]'>
            ...
            <div className='flex flex-row justify-between items-center mb-[16px]'>
                <div className='flex items-baseline'>
                    <span className='font-medium text-[16px] leading-[24px] text-[#2D3436]'>Line Chart</span>
                    <span className='font-semibold text-[12px] leading-[12px] text-[#636E72] ml-[10px]'>Website Visit</span>
                </div>
            ...
            {/* Chart component */}
            <ReactECharts style={{ width: '100%', height: '300px' }} option={options} />
        </div>
    );
}
